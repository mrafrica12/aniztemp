...
const DEFAULT_BANNERS = [
  ...
  {
    text: 'AIDS Walk Atlanta 5K & Music Festival — support Aniz, Inc. and local HIV/AIDS services.',
    linkText: 'Learn more',
...
document.querySelectorAll('.smart-form').forEach(form => {
  ...
  form.addEventListener('submit', async e => {
    ...
    const honeypot = form.querySelector('input[name="website"], input[name="url"], input[data-honeypot="true"]');
    ...
    // Timestamp validation: reject if submitted in under 3 seconds
    ...
    data.submissionTimeSeconds = elapsedSeconds;
...
window.Aniz, Inc._DEFAULTS = { team: DEFAULT_TEAM };
